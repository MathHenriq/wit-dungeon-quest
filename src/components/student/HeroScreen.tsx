...
export function HeroScreen({ student, inventory, onUpdate, onBack }: HeroScreenProps) {
  ...
  // NOTE: must be declared BEFORE the useEffect below, which depends on
  // `wave11Class` — otherwise the dep array hits a Temporal Dead Zone and
  // the HeroScreen never renders.
