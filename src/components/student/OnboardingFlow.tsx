...
const CLASSES: ClassDef[] = [
  {
    ...
    description: "Enfrenta bugs de frente. Especialista em debug e resolução de problemas complexos.",
    Icon: SwordIcon,
  },
  {
    id: "Mago",
    ...
    description: "Domina os feitiços do código. Especialista em algoritmos e lógica.",
    Icon: WandIcon,
  },
  {
    id: "Arqueiro",
    ...
    description: "Mira certeira nos dados. Especialista em análise de dados e visualização.",
    Icon: BowIcon,
  },
  {
    id: "Curandeiro",
    ...
    description: "Fortalece a equipe. Especialista em colaboração e ensino.",
    Icon: HeartIcon,
  },
];
