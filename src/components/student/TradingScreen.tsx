...
import { ArrowLeftRight, CheckCircle, X, Loader2, Clock, ArrowLeft } from "lucide-react";
...
function CategoryLabel({ category }: { category: string }) {
  ...
  return (
    <span style={{
      ...
      color: m.color, letterSpacing: "0.8px",
      opacity: 0.85,
    }}>
      {m.label}
    </span>
...
export function TradingScreen({ student, inventory, onBack, onInventoryChanged }: Props) {
  ...
  const mySelectedItem = myItems.find(i => i.item.id === myItemId);
  const theirSelectedItem = receiverItems.find(i => i.item.id === theirItemId);
  ...
  async function handlePropose() {
    ...
    try {
      ...
      setMyItemId(""); setTheirItemId(""); setReceiverId("");
    } catch (err: unknown) {
      ...
      <div className="tr-screen">
          ...
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 16 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <span style={{
                ...
                fontWeight: 800, color: "#00f0e0", letterSpacing: "5px",
              }}>
                SISTEMA DE TROCA
              </span>
              <span style={{
        ...
        <div style={{
          ...
          {(["propose", "incoming", "history"] as const).map(t => (
            <button key={t} className={`tr-tab${tab === t ? " active" : ""}`}
              onClick={() => setTab(t)}>
              {t === "propose" ? "PROPOSTA"
            ...
            <div className="tr-fade" style={{ flex: 1, display: "flex", gap: 14, overflow: "hidden" }}>
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 0, overflow: "hidden" }}>
                <div className="tr-panel tr-panel-inner" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", borderRadius: 8 }}>
                  <PanelHeader label="VOCÊ OFERECE" sub={mySelectedItem ? mySelectedItem.item.name.toUpperCase() : "— SELECIONE —"} />
                  ...
                  <div className="tr-scroll" style={{ flex: 1, overflowY: "auto", padding: "8px 8px" }}>
                    {myItems.length === 0 ? (
                      ...
                      <div
                        key={inv.id}
                        className={`tr-item-row${myItemId === item.id ? " offer-selected" : ""}`}
                        style={{ animationDelay: `${idx * 0.04}s` }}
                        onClick={() => setMyItemId(prev => prev === item.id ? "" : item.id)}
                      >
                        ...
                        {(() => {
                          ...
                          return t > 0 ? (
                            <span style={{
                              ...
                              color: "rgba(251,191,36,0.8)", letterSpacing: "0.5px",
                            }}>+{t}</span>
                          ) : null;
                        })()}
                        {/* Selection indicator */}
              ...
              <div style={{ width: 180, display: "flex", flexDirection: "column", gap: 10, flexShrink: 0 }}>
                ...
                <div className="tr-panel" style={{ borderRadius: 8, flex: 1, display: "flex", flexDirection: "column" }}>
                  ...
                  <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "12px 10px", gap: 12 }}>
                    ...
                    <div style={{ width: "100%", padding: "8px 10px", borderRadius: 5, background: "rgba(255,120,0,0.08)", border: "1px solid rgba(255,120,0,0.2)", textAlign: "center" }}>
                      <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 7, color: "rgba(255,120,0,0.6)", letterSpacing: "1.5px", marginBottom: 4 }}>OFERECE</div>
                      {mySelectedItem ? (
                        <>
                          <ItemIcon item={mySelectedItem.item} size={32} />
                          <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, fontWeight: 700, color: "#ff9940", marginTop: 4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {mySelectedItem.item.name}
                          </div>
                        </>
                      ) : (
                        <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 9, color: "rgba(255,120,0,0.3)", letterSpacing: "1px" }}>
                          VAZIO
                        </div>
                      )}
                    </div>
                    ...
                    <div style={{ width: "100%", padding: "8px 10px", borderRadius: 5, background: "rgba(0,200,190,0.06)", border: "1px solid rgba(0,200,190,0.18)", textAlign: "center" }}>
                      <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 7, color: "rgba(0,200,190,0.5)", letterSpacing: "1.5px", marginBottom: 4 }}>RECEBE</div>
                      {theirSelectedItem ? (
                        <>
                          <ItemIcon item={theirSelectedItem.item} size={32} />
                          <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, fontWeight: 700, color: "#00f0e0", marginTop: 4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {theirSelectedItem.item.name}
                          </div>
                        </>
                      ) : (
                        <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 9, color: "rgba(0,200,190,0.3)", letterSpacing: "1px" }}>
                          QUALQUER
                        </div>
                      )}
                    </div>
                ...
                <button
                  ...
                  disabled={isProposing || !myItemId || !receiverId}
                  style={{
                    width: "100%", padding: "12px 0", borderRadius: 6, cursor: "pointer",
                    background: myItemId && receiverId ? "rgba(0,200,190,0.12)" : "rgba(0,200,190,0.03)",
                    border: `1px solid ${myItemId && receiverId ? "rgba(0,200,190,0.45)" : "rgba(0,200,190,0.12)"}`,
                    color: myItemId && receiverId ? "#00f0e0" : "rgba(0,200,190,0.25)",
                    fontFamily: "'Orbitron', sans-serif", fontSize: 9,
                    fontWeight: 700, letterSpacing: "3px",
                    display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                    transition: "all 0.18s ease",
                    boxShadow: myItemId && receiverId ? "0 0 20px rgba(0,200,190,0.1)" : "none",
                  }}
                >
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 0, overflow: "hidden" }}>
                <div className="tr-panel tr-panel-inner" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", borderRadius: 8 }}>
                  <PanelHeader
                    ...
                    sub={theirSelectedItem ? theirSelectedItem.item.name.toUpperCase() : "— OPCIONAL —"}
                  />
                  ...
                  <div className="tr-scroll" style={{ flex: 1, overflowY: "auto", padding: "8px 8px" }}>
                    {!receiverId ? (
                      ...
                      <div
                        key={inv.id}
                        className={`tr-item-row${theirItemId === item.id ? " selected" : ""}`}
                        style={{ animationDelay: `${idx * 0.04}s` }}
                        onClick={() => setTheirItemId(prev => prev === item.id ? "" : item.id)}
                      >
                        <ItemIcon item={item} size={38} />
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div className="tr-item-name" style={{
            ...
            <div className="tr-fade" style={{ flex: 1, overflow: "hidden" }}>
              {isLoading ? (
                ...
                <div style={{
                  ...
                  color: "rgba(0,200,190,0.25)", letterSpacing: "3px",
                }}>
                    ...
                    return (
                      <div key={trade.id} className="tr-trade-card" style={{ animationDelay: `${idx * 0.07}s` }}>
                        ...
                        <div style={{ padding: "12px 14px", display: "flex", alignItems: "center", gap: 12 }}>
                          {/* Proposer item */}
                          <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", borderRadius: 5, background: "rgba(255,120,0,0.06)", border: "1px solid rgba(255,120,0,0.15)" }}>
                            {trade.proposer_item ? <ItemIcon item={trade.proposer_item} size={36} /> : <div style={{ width: 36, height: 36 }} />}
                            <div style={{ minWidth: 0 }}>
                              <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 7, color: "rgba(255,120,0,0.5)", letterSpacing: "1px", marginBottom: 2 }}>ELE DÁ</div>
                              <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 13, fontWeight: 700, color: "#ff9940", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                          ...
                          {/* Receiver item */}
                          <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 10, padding: "8px 10px", borderRadius: 5, background: "rgba(0,200,190,0.05)", border: "1px solid rgba(0,200,190,0.15)" }}>
                            {trade.receiver_item ? <ItemIcon item={trade.receiver_item} size={36} /> : <div style={{ width: 36, height: 36, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, color: "rgba(0,200,190,0.2)" }}>?</div>}
                            <div style={{ minWidth: 0 }}>
                              <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 7, color: "rgba(0,200,190,0.4)", letterSpacing: "1px", marginBottom: 2 }}>ELE QUER</div>
                              <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 13, fontWeight: 700, color: "#00f0e0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                {trade.receiver_item?.name ?? "QUALQUER ITEM"}
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className="tr-fade" style={{ flex: 1, overflow: "hidden" }}>
              {isLoading ? (
                ...
                <div className="tr-scroll" style={{ height: "100%", overflowY: "auto", display: "flex", flexDirection: "column", gap: 6, paddingRight: 4 }}>
                  {/* Header row */}
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 100px 80px", gap: 8, padding: "4px 12px 8px", borderBottom: "1px solid rgba(0,180,170,0.15)" }}>
                  ...
                  {historyTrades.map((trade, idx) => {
                    ...
                    return (
                      <div key={trade.id}
                        style={{
                          display: "grid", gridTemplateColumns: "1fr 1fr 1fr 100px 80px", gap: 8,
                        ...
                        <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 9, color: "rgba(0,200,190,0.4)", letterSpacing: "0.5px" }}>
                          {trade.resolved_at
                            ? new Date(trade.resolved_at).toLocaleDateString("pt-BR", { day: "2-digit", month: "2-digit" })
                            : "—"}
                        </span>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                          {myItem && <ItemIcon item={myItem} size={24} />}
                          <span style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, fontWeight: 600, color: "#ff9940", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {myItem?.name ?? "—"}
                          </span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                          {theirItem && <ItemIcon item={theirItem} size={24} />}
                          <span style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 12, fontWeight: 600, color: "#00f0e0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {theirItem?.name ?? "QUALQUER"}
                          </span>
                        </div>
        ...
        <div style={{
          ...
          <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 8, color: "rgba(0,200,190,0.25)", letterSpacing: "1.5px" }}>
            SISTEMA DE TROCA v2.1 · {student.character_name ?? student.name}
          </span>
