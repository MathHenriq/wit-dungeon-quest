...
export const ART_PROMPTS_3: Record<string, string> = {
  ...
  'mahoraga': 'no humans, mahoraga, jujutsu kaisen, giant shikigami, wheel above head, white body, sword arm, ruined city',
  ...
  'shinra-tensei': '1boy, pain (naruto), naruto (series), orange spiky hair, piercings, rinnegan, shinra tensei, city crater, shockwave',
  'chibaku-tensei': '1boy, pain (naruto), naruto (series), rinnegan, chibaku tensei, giant rock sphere in sky, gravity, debris',
  ...
  'izanagi': '1boy, shimura danzou, naruto (series), bandages, sharingan arm, izanagi, reality rewinding, shattered glass',
  ...
  'genki-dama': '1boy, son goku, dragon ball, hands raised, spirit bomb, giant blue energy sphere above, planet',
