...
export const ART_PROMPTS_2: Record<string, string> = {
  ...
  'hidrificacao': 'no humans, naruto (series), human-shaped water splash, liquid body, puddle, broad sword on ground, mist',
  ...
  'contracorrente': 'no humans, avatar: the last airbender, giant ocean wave curling, water wall, whirlpool, foam, sunset, only water',
  ...
  'kodama': 'no humans, kodama (mononoke hime), mononoke hime, many tiny white tree spirits with round heads, sitting on mossy roots, forest',
  ...
  'floresta-nativa': 'no humans, naruto (series), wood release, giant trees erupting from ground, huge roots, forest growing fast, dust',
  ...
  'nascimento-das-arvores': 'no humans, naruto (series), deep forest emergence, massive trees erupting across battlefield, wood release, mist',
  ...
  'demonio-do-veneno': 'no humans, one piece, giant demon shape made of purple liquid poison, dripping, dark prison corridor, bars',
  ...
  'konjiki-ashisogi-jizo': 'no humans, bleach, giant golden caterpillar with baby face, purple poison mist, dark sky',
  // Gelo
...
/** Coleção 3: golpes icônicos, quase todos full art (retrato). */
export const ART_PROMPTS_3: Record<string, string> = {
  'soco-serio': '1boy, saitama (one-punch man), one-punch man, bald, yellow suit, red gloves, white cape, serious face, serious punch, clouds splitting, massive shockwave',
  'gear-5': '1boy, monkey d. luffy, one piece, gear 5, white hair, white clothes, laughing, clouds around, sun god nika, cartoonish power',
  'santuario-malevolente': '1boy, ryoumen sukuna, jujutsu kaisen, pink hair, four eyes, face markings, malevolent shrine, domain expansion, shrine with skulls, slashes',
  'mahoraga': 'no humans, jujutsu kaisen, mahoraga, giant pale humanoid shikigami, eight-handled dharma wheel floating above head, sword arm, ruined city',
  'rinne-tensei': '1boy, nagato (naruto), naruto (series), red hair, rinnegan, gedo mazo statue, souls returning, light',
  'hakai': '1boy, beerus, dragon ball super, purple cat god, egyptian clothes, hakai, purple destruction energy in hand',
  'susanoo': '1boy, uchiha itachi, naruto (series), akatsuki cloak, red susanoo, giant spectral warrior, sword and shield',
  'modo-kurama': '1boy, uzumaki naruto, naruto (series), kurama chakra mode, golden flame cloak, black markings, nine tails behind',
  'kamui': '1boy, hatake kakashi, naruto (series), mangekyou sharingan, kamui, spiral distortion, dimension vortex',
  'shinra-tensei': 'no humans, naruto (series), shinra tensei, giant circular crater in destroyed village, shockwave rings, aerial view',
  'chibaku-tensei': 'no humans, naruto (series), chibaku tensei, giant rock sphere floating in sky, gravity pulling boulders upward, crater below, dramatic sky',
  'tengai-shinsei': '1boy, uchiha madara, naruto (series), long spiky black hair, red armor, rinnegan, giant meteor falling from sky',
  'bajrang-gun': '1boy, monkey d. luffy, one piece, gear 5, giant fist from sky, bajrang gun, clouds, island',
  'sanzen-sekai': '1boy, roronoa zoro, one piece, green hair, three sword style, sword in mouth, sanzen sekai, spinning blades, battlefield',
  'decima-terceira-forma': '1boy, tsugikuni yoriichi, kimetsu no yaiba, long hair, hanafuda earrings, sun breathing, flaming sword, sunrise',
  'tita-colossal': 'no humans, colossal titan, shingeki no kyojin, skinless giant, steam, explosion, wall, sunset',
  'fuga': '1boy, ryoumen sukuna, jujutsu kaisen, pink hair, face markings, fire arrow, fuga, huge flame bow',
  'all-for-one': '1boy, all for one (boku no hero academia), boku no hero academia, black suit, mask with tubes, dark energy arm, villain',
  'modo-demonio': '1boy, asta (black clover), black clover, black demon form, one black horn, anti-magic, demon slayer sword, black aura',
  'zanka-no-tachi': '1boy, yamamoto genryuusai shigekuni, bleach, old man, long white beard, scarred, burned sword, bankai, heat haze',
  'gon-adulto': '1boy, gon freecss, hunter x hunter, adult gon, long black spiky hair, muscular, dark nen aura, rage',
  'ultra-ego': '1boy, vegeta, dragon ball super, ultra ego, purple hair, purple aura, grin, destruction energy',
  'kirin': '1boy, uchiha sasuke, naruto (series), sharingan, kirin, giant lightning dragon from sky, storm clouds',
  'tsukuyomi-infinito': 'no humans, naruto (series), infinite tsukuyomi, giant red moon with rinnegan pattern, sleeping world, divine tree',
  'kotoamatsukami': '1boy, uchiha shisui, naruto (series), curly black hair, mangekyou sharingan, glowing eye, crows',
  'izanagi': 'no humans, naruto (series), glowing sharingan eye closing, shattered glass fragments, rewinding clock pieces, dark background',
  'sessenta-e-quatro-palmas': '1boy, hyuuga neji, naruto (series), long hair, byakugan, gentle fist, sixty four palms, eight trigrams circle',
  'kamui-raikiri': '1boy, hatake kakashi, naruto (series), silver hair, mask, purple lightning, kamui raikiri, mangekyou sharingan',
  'genki-dama': '1boy, male focus, son goku, dragon ball z, orange gi, spiky black hair, both arms raised, giant blue energy sphere above head, planet surface',
  'makankosappo': '1boy, piccolo, dragon ball z, green skin, two fingers on forehead, special beam cannon, spiral beam',
  'red-hawk': '1boy, monkey d. luffy, one piece, straw hat, haki arm, flaming punch, red hawk',
  'kong-gun': '1boy, monkey d. luffy, one piece, gear fourth, bounceman, giant fist, kong gun',
  'vasto-lorde': '1boy, kurosaki ichigo, bleach, vasto lorde, white hollow form, long orange hair, horns, cero',
  'nona-forma-rengoku': '1boy, rengoku kyoujurou, kimetsu no yaiba, flame hair, flame haori, ninth form rengoku, giant flame dragon slash',
  'nevoa-obscura': '1boy, tokitou muichirou, kimetsu no yaiba, long black and teal hair, mist breathing, obscuring clouds, katana',
  'igris-o-cavaleiro-de-sangue': 'no humans, igris, ore dake level up na ken, red armored knight, blood red cape, sword, shadow soldier',
  'beru-o-rei-formiga': 'no humans, beru (solo leveling), ore dake level up na ken, black ant king, wings, claws, shadow soldier',
  'meruem': '1boy, meruem, hunter x hunter, chimera ant king, green skin, tail, royal robe, board game',
  'ataque-giratorio': '1boy, levi (shingeki no kyojin), shingeki no kyojin, spinning attack, dual blades, mobility gear, titan nape',
  'tita-de-ataque': 'no humans, attack titan, shingeki no kyojin, titan roaring, long hair, glowing eyes, city ruins',
  'predador': 'no humans, rimuru tempest, tensei shitara slime datta ken, blue slime, cute, absorbing magic, glowing runes',
  'star-burst-stream': '1boy, kirito, sword art online, black coat, dual wielding swords, star burst stream, blue light trails',
  'leitura-de-mentes': '1girl, anya (spy x family), spy x family, child, pink hair, green eyes, school uniform, fully clothed, smug face, upper body',
  'operacao-strix': '1boy, loid forger, spy x family, blonde hair, suit, spy, holding pistol, city night',
  'punho-kaiju': '1boy, kafka hibino, kaiju no. 8, kaiju form, black skull armor, punch, city',
  'turbo': '1boy, okarun (dandadan), dandadan, glasses, turbo form, white hair, running super fast, spirit aura',
  'assassino-aposentado': '1boy, sakamoto taro, sakamoto days, chubby, glasses, apron, convenience store, dodging bullets',
  'himmel-o-heroi': '1boy, himmel (sousou no frieren), sousou no frieren, blue hair, cape, hero sword, smiling, flower field',
  'punho-divergente': '1boy, itadori yuuji, jujutsu kaisen, pink hair, divergent fist, delayed cursed energy, punch',
  'howitzer-impact': '1boy, bakugou katsuki, boku no hero academia, spiky blond hair, spinning, howitzer impact, huge explosion',
};
